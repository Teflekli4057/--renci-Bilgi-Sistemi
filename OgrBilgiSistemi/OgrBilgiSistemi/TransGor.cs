...
{
    public partial class TransGor : Form
    {
        public TransGor()
        {
            InitializeComponent();
        ...
        void Listele()
        {
            ...
            con1.Open();
            string query3 = $"select Ders_kodu as 'Ders Kodu',Ders_adi as 'Ders Adı',Vize as 'Vize Notu',Final as 'Final Notu',Ortalama ,Dvz 'Devam Durumu' ,Durum from [{alinanDgr}]";
        ...
        private void TransGor_Load(object sender, EventArgs e)
        {
            Listele();
        }
